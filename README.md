...
The figure above (Figure 14) shows the not completed tasks and the checkboxes that can be ticked when the task is completed. Also, there is a sidebar.  
...
The figure above (Figure 15) shows the deleted tasks.  Also, there is a sidebar.  
