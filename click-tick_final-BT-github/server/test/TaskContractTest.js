...
describe("Task Contract", function() {
  ...
  beforeEach(async function() {
    ...
    for(let i=0; i<NUM_TOTAL_TASKS; i++) {
      ...
      await taskContract.addTask(task.taskText, task.taskDescription, task.isDeleted);
  ...
  describe("Add Task", function() {
    it("should emit AddTask event", async function() {
      ...
      await expect(await taskContract.addTask(task.taskText, task.taskDescription, task.isDeleted)
